...
class ChatbotPerformanceTester:
    ...
    async def test_context_loading(self, lesson_id: int = 1, auth_token: str = "test_token") -> Dict[str, Any]:
    ...
    async def test_single_chat_response(self, 
                                      ...
                                      lesson_id: int = 1,
                                      mode: str = "default",
                                      auth_token: str = "test_token") -> Dict[str, Any]:
    ...
    async def test_websocket_chat(self, 
        ...
        try:
            ...
            async with monitor_phase(self.monitor, "websocket_connection") as monitor:
                websocket_url = f"ws://localhost:8000/ws/chat/{session_id}?token={auth_token}"
        ...
        try:
            async with monitor_phase(self.monitor, "concurrent_chat_sessions") as monitor:
                ...
                for user_id in range(concurrent_users):
                    ...
                    isolated_tester = ChatbotPerformanceTester(self.ai_service_url, self.frontend_url)

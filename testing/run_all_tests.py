...
class ComprehensiveTestRunner:
    ...
    def __init__(self, output_dir: str = "testing/results"):
        ...
        self.lesson_tester = LessonGeneratorPerformanceTester(performance_monitor=self.monitor)
        self.chatbot_tester = ChatbotPerformanceTester(performance_monitor=self.monitor)
